        ...
        <section  class="">
            <table class = "table table-condensed">
                ...
                foreach($parts as $value) {
                    ...
                    echo '<td>'.$value["description"].' <a href="http://seltex.ru:5555/catalog/'.$value['ProductID'].'" class="glyphicon glyphicon-info-sign" aria-hidden="true" style="color:#18BC9C; padding-left:10px;" title="Показать содержание"></a></td>';
                    if($value["price"]) {
